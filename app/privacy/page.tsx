...
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/20 selection:text-primary">
      <Navbar />
      <div className="container max-w-4xl mx-auto px-6 py-24 sm:py-32">
        <div className="mb-12">
          <Link 
            href="/"
            className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 mb-8 group"
          >
          ...
          <p className="text-muted-foreground text-lg">Effective Date: April 2026</p>
        </div>

        <div className="prose prose-invert prose-slate max-w-none space-y-8 text-muted-foreground leading-relaxed">
          <section>
            <p>
              Welcome to <strong>SAMKIEL</strong>. This Privacy Policy explains how we collect, use, and protect your personal information when you visit our website at <Link href="https://samkiel.tech" className="text-primary hover:underline">samkiel.tech</Link> or use any of our studio products.
            </p>
            <p>
              At SAMKIEL, we are committed to protecting your privacy in accordance with the <strong>Nigeria Data Protection Regulation (NDPR)</strong> and other applicable laws.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Contact Information:</strong> Name, email address, and phone number when you fill out a form.</li>
              ...
              <li><strong>Client Data:</strong> Information provided to us for the purpose of executing software development projects.</li>
              <li><strong>Product Data:</strong> Data generated or provided when using our studio products (e.g., BreezrChat, SKDL).</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Right to object:</strong> you can object to processing of your data in certain circumstances.</li>
              <li><strong>Right to data portability:</strong> you can request your data in a portable format.</li>
            </ul>
            <p className="mt-4">
              To exercise any of these rights, contact us at <a href="mailto:hello@samkiel.tech" className="text-primary hover:underline">hello@samkiel.tech</a>. We will respond within 30 days.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              SAMKIEL's website and products are not directed at children under the age of 18. We do not knowingly collect personal data from children. If you believe we have inadvertently collected data from a minor, please contact us immediately at <a href="mailto:hello@samkiel.tech" className="text-primary hover:underline">hello@samkiel.tech</a> and we will delete it promptly.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">9. Contact & Complaints</h2>
            <p>
