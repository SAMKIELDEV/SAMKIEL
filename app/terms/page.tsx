    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/20 selection:text-primary">
      ...
      <div className="container max-w-4xl mx-auto px-6 py-24 sm:py-32">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8 text-muted-foreground leading-relaxed">
          <section>
            <p>
              Welcome to <strong>SAMKIEL</strong>. By accessing or using our website at <Link href="https://samkiel.tech" className="text-primary hover:underline">samkiel.tech</Link>, or any of our studio products (including BreezrChat and SKDL), you agree to be bound by these Terms of Service. Please read them carefully before using our services.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">3. Use of Our Website and Products</h2>
            <div className="space-y-4">
              <h3 className="text-xl font-medium text-foreground">3.1 Permitted Use</h3>
            ...
            <div className="space-y-4 mt-6">
              <h3 className="text-xl font-medium text-foreground">3.2 Availability</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">4. Client Services (Agency)</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">5. Studio Products</h2>
            <p>
